...
|-------|------------|--------------------|
|Action | type Action func(minX, minY, maxX, maxY int) | It is use for passing to methods a function called on every region of image or slice in parallel. The values **minX**, **minY** are the inferior limit of region, and **maxX**, **maxY** are the superior limit.|
